      ...
      <div>
        <div>
          ...
          <div className='flex justify-center gap-[700px]'>
            <div className='flex'>
              <h1 className='ml-10 text-xl font-bold text-sky-900'>All</h1>
              <div>
                <h1 className='ml-10 text-xl font-semibold text-sky-900'>WareHouse</h1>
                <div className='-ml-9 mt-2 w-12 h-[2px] bg-sky-900'/>
              </div>
            </div>
            <div className='w-auto h-auto str  ml-[90px] pr-4'>
            ...
            <div>
              <div className='pl-20 flex bg-white py-2'>
                ...
                <div className='flex gap-28 -ml-10'>
                  ...
                  <h1 className='font-semibold ml-3'>25</h1>
                  <h1 className='font-semibold pl-24 -ml-24'>11 January 2022</h1>
                  <h1 className='font-semibold pl-24 -ml-28'>450L00</h1>
                </div>
              </div>
